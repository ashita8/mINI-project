...
os.chdir(directory)  #change direcoty by changing path here directory is new path
songlist = os.listdir() #content of list directory
playlist = tkr.Listbox(musicplayer,font = "Helvetica 12 bold",bg = "yellow",selectmode = tkr.SINGLE)
#contail text file only of same color and font
for item in songlist:
    pos = 0
    playlist.insert(pos,item)
    pos +=1
    # pygamemexer is used to play songs
...
var = tkr.StringVar() #stringvar is a class from tkinter it is used to montior changes on tk and to access values
...
playlist.pack(fill= "both",expand = "yes") #both fill both horizontally and vertically expand if necessary is yes
